...
use Exception;
use Batyukovstudio\ApiatoSwaggerGenerator\Exceptions\InvalidDefinitionException;
use ReflectionClass;
...
use Batyukovstudio\ApiatoSwaggerGenerator\Parameters;
use Batyukovstudio\ApiatoSwaggerGenerator\DataObjects;
...
use Batyukovstudio\ApiatoSwaggerGenerator\Definitions\DefinitionGenerator;
use Batyukovstudio\ApiatoSwaggerGenerator\Exceptions\InvalidAuthenticationFlow;
use Batyukovstudio\ApiatoSwaggerGenerator\Exceptions\SchemaBuilderNotFound;
...
//        Arr::set($documentation, 'components.schemas', $this->definitionGenerator->generateSchemas());
    ...
    private function generateCustomResponseSchema(string $operation, string $model, string $uri) {
        ...
        try {
            ...
            throw new Exception("SchemaBuilder must implements Batyukovstudio\ApiatoSwaggerGenerator\Responses\SchemaBuilder interface");
        }
    }
