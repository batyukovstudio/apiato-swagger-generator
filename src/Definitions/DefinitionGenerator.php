...
namespace Batyukovstudio\ApiatoSwaggerGenerator\Definitions;
 ...
 * @package Batyukovstudio\ApiatoSwaggerGenerator\Definitions
 */
class DefinitionGenerator {
                ...
                */
                ...
                foreach ($appends->getValue($obj) as $item) {
                    ...
                    if ( ! $reflection->hasMethod($methodeName)) {
                        Log::warning("[Batyukovstudio\ApiatoSwaggerGenerator] Method $model::$methodeName not found while parsing '$item' attribute");
                        continue;
                    }
